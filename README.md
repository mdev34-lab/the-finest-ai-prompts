...
├── AGENTS.md                 # Meta-rules for directive management
├── Alpha.md                  # Generalist system directive
├── Coder.md                  # Software development protocol
├── DeepCoder.md              # Advanced technical analysis
├── Sherlock.md               # Research and investigation
├── Lifewise.md               # Life guidance and wisdom
├── R-Prompt (legacy).md      # Chain-of-thought reasoning
├── R-Image.md                # Image generation
├── Image to Prompt.md        # Image-to-text conversion
└── Designer/                 # Design skill collection
    ├── Designer (latest).md
    ├── Designer Mini (latest).md
    ├── Designer-XL Preview (latest).md
    └── Archived Versions/    # Legacy versions
        ├── Designer v1.0 (read-only).md
        ├── Designer v4.8 (read-only).md
        └── Designer v5.0 (read-only).md
```
...
All skills in this collection adhere to:
- **CC BY 4.0 Licensing** - Maximum compatibility and sharing
- **Professional Quality** - Production-ready protocols
...
1. Follow the established formatting standards
2. Maintain the CC BY 4.0 licensing
...
This entire collection is licensed under the **Creative Commons Attribution 4.0 International License (CC BY 4.0)**.
...
Each skill has been intensely and iteratively refined through human and AI-driven feedback loops utilizing vibe coding agents (Windsurf, Kilo, etc) as updaters.

## 📞 Support

For questions, issues, or contributions:
- Review the specific skill documentation
- Open an issue for bugs or improvements
- Submit pull requests following established guidelines
